...
class AddSellingRequestScreen extends StatefulWidget {
  const AddSellingRequestScreen({Key? key}) : super(key: key);

  @override
  _AddSellingRequestScreenState createState() =>
      _AddSellingRequestScreenState();
}

class _AddSellingRequestScreenState extends State<AddSellingRequestScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        SellingBuyingModel data = SellingBuyingModel(
            ...
            date: {".sv": "timestamp"});
        await db.addBuyingSellingRequest('sellingRequests', data.toMap());
                          ...
                          IntrinsicHeight(
                            child: TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (val == null) {
                                  return strings[
                                      "form_form_price_per_coin_validate"]!;
                                }
                                return null;
                              },
                            ),
