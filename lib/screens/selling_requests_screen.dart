...
import 'add_selling_request_screen.dart';

class SellingRequestsScreen extends StatefulWidget {
  const SellingRequestsScreen({Key? key}) : super(key: key);

  @override
  _SellingRequestsScreenState createState() => _SellingRequestsScreenState();
}

class _SellingRequestsScreenState extends State<SellingRequestsScreen> {
  ...
  void _filterRequests() {
    ...
    setState(() {
      _requests =
          _allRequests.where((element) => element.sellerUId == db.uId).toList();
    });
  }
